...
ALGORITHMS: List[AlgorithmHandler] = [
  AlgorithmHandler(
    ...
    description='Classical linear recurrence with multiplier and increment parameters; models Park–Miller and libc rand variants.',
    sample={
      'sequence': [
        1250496027,
        1116302264,
  ...
  AlgorithmHandler(
    ...
    generator=None,
    description='Simple arithmetic progression useful for spotting linear drift masquerading as randomness.',
  ...
  AlgorithmHandler(
    ...
    description='Second-order recurrence with squared state term delivering higher curvature than LCGs.',
    sample={
  ...
  AlgorithmHandler(
    ...
    description='Compact Marsaglia XORShift variant using three shift/xor stages over a 32-bit state.',
    sample={
  ...
  AlgorithmHandler(
    ...
    description='Cryptographically strong quadratic residue generator relying on large composite moduli.',
  ...
  AlgorithmHandler(
    ...
    description='Recurrence that sums older taps of the sequence; parameterised by lag pair (j, k).',
  ...
  AlgorithmHandler(
    ...
    description='Chaotic logistic map constrained to floating point, ideal for spotting deterministic chaos.',
    sample={
  ...
  AlgorithmHandler(
    ...
    description='Marsaglia multiply-with-carry design coupling multiplication with an explicit carry accumulator.',
  ...
  AlgorithmHandler(
    ...
    description='Classic 128-bit XORShift state machine providing a longer period than XORShift32.',
  ...
  AlgorithmHandler(
    ...
    description='NVIDIA-friendly XORShift variant augmented with a Weyl sequence to break linear artifacts.',
  ...
  AlgorithmHandler(
    ...
    description='Widely used 19937-bit period generator with tempering for equidistribution.',
  ...
  AlgorithmHandler(
    ...
    description='Well Equidistributed Long-period Linear generator with 512-bit state and improved equidistribution.',
  ...
  AlgorithmHandler(
    ...
    description='1024-bit WELL variant balancing quality and performance for simulations.',
  ...
  AlgorithmHandler(
    ...
    description='Long-period WELL generator engineered as a drop-in upgrade over MT19937.',
  ...
  AlgorithmHandler(
    ...
    description='Von Neumann middle-square method—useful as a cautionary tale for RNG design.',
  ...
  AlgorithmHandler(
    ...
    description='NIST-style deterministic random bit generator built on AES in counter mode.',
  ...
  AlgorithmHandler(
    ...
    description='Stream cipher core popularised by TLS—excellent diffusion and speed for random streams.',
  ...
  AlgorithmHandler(
    ...
    description='Hash-based deterministic random bit generator using SHA-256 update and reseed routines.',
  ...
  AlgorithmHandler(
    ...
    description='Entropy accumulator with multiple pools feeding a block-cipher generator à la Schneier/Ferguson.',
  ...
  AlgorithmHandler(
    ...
    description='Permuted Congruential Generator with xorshifted output and random rotation.',
  ...
  AlgorithmHandler(
    ...
    description='Statistically robust 64-bit mixer frequently used to seed xoshiro/xoroshiro families.',
  ...
  AlgorithmHandler(
    ...
    description='Xoroshiro variant combining XOR/rotate/shift for excellent 128-bit throughput.',
  ...
  AlgorithmHandler(
    ...
    description='High-quality xoshiro family member with 256-bit state and star-star output scrambler.',
  ...
  AlgorithmHandler(
    ...
    description='Low-discrepancy radical-inverse sequence ideal for sampling multi-dimensional spaces.',
  ...
  AlgorithmHandler(
    ...
    description='Direction-number-based quasi-random points with strong stratification in low dimensions.',
    sample={'count': 8},
  ),
  AlgorithmHandler(
    key='niederreiter',
    ...
    description='Gray-coded Niederreiter base-2 sequence used for deterministic Monte Carlo integration.',
    sample={'count': 8},
  ),
  AlgorithmHandler(
    key='tent-map',
    ...
    description='Piecewise-linear chaotic map with parameter-controlled bifurcations.',
  ...
  AlgorithmHandler(
    ...
    description='Two-dimensional dissipative chaotic map producing rich strange attractors.',
